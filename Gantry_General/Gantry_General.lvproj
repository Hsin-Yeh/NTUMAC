...
<Project Type="Project" LVVersion="16008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Classes" Type="Folder">
			<Item Name="Controllers" Type="Folder">
				<Item Name="Motion" Type="Folder">
					<Item Name="A3200.lvclass" Type="LVClass" URL="../Classes/Controller/Motion/A3200 Folder/A3200.lvclass"/>
					<Item Name="Motion.lvclass" Type="LVClass" URL="../Classes/Controller/Motion/Motion Folder/Motion.lvclass"/>
				</Item>
				<Item Name="I-O" Type="Folder">
					<Item Name="I-O.lvclass" Type="LVClass" URL="../Classes/Controller/I-O/I-O Folder/I-O.lvclass"/>
					<Item Name="NI-DAQ.lvclass" Type="LVClass" URL="../Classes/Controller/I-O/NI-DAQ Folder/NI-DAQ.lvclass"/>
				</Item>
				<Item Name="Camera" Type="Folder">
					<Item Name="Edmund Optics.lvclass" Type="LVClass" URL="../Classes/Controller/Camera/Edmund Optics Folder/Edmund Optics.lvclass"/>
					<Item Name="Camera.lvclass" Type="LVClass" URL="../Classes/Controller/Camera/Camera Folder/Camera.lvclass"/>
				</Item>
				<Item Name="Dispenser" Type="Folder">
					<Item Name="Dispenser.lvclass" Type="LVClass" URL="../Classes/Controller/Dispenser/Dispenser Folder/Dispenser.lvclass"/>
					<Item Name="Ultimus V2.lvclass" Type="LVClass" URL="../Classes/Controller/Dispenser/Ultimus V2 Folder/Ultimus V2.lvclass"/>
				</Item>
				<Item Name="Controller.lvclass" Type="LVClass" URL="../Classes/Controller/Controller Folder/Controller.lvclass"/>
			</Item>
		...
		<Item Name="Init.vi" Type="VI" URL="../Classes/Controller/Camera/light Folder/Init.vi"/>
		<Item Name="Change light.vi" Type="VI" URL="../Classes/Controller/Camera/light Folder/Change light.vi"/>
		<Item Name="Close.vi" Type="VI" URL="../Classes/Controller/Camera/light Folder/Close.vi"/>
